...
class clientCheckout extends StatefulWidget {
...
class _clientCheckoutState extends State<clientCheckout> {
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Text("Customer name",style: TextStyle(fontSize: 17, fontFamily: 'Kollektif')),
                            ],
                          ),
                          Padding(
