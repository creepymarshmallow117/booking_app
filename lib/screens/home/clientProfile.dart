                                                              ...
                                                              children: [
                                                                new GestureDetector(
                                                                  onTap: () {
                                                                    Navigator.pop(context);
                                                                    Navigator.push( context,
                                                                      MaterialPageRoute(builder: (context) => EditClientProfile(editFieldChoice: 'description',)),
                                                                    );
                                                                  },
                                                                  child: roundedButton(
                                                                      "DESCRIPTION",
                                                                ...
                                                                new GestureDetector(
                                                                  onTap: () {
                                                                    Navigator.pop(context);
                                                                    Navigator.push( context,
                                                                      MaterialPageRoute(builder: (context) => EditClientProfile(editFieldChoice: 'timing',)),
                                                                    );
                                                                  },
                                                                  child: roundedButton(
                                                                      "TIMING",
                                                                ...
                                                                new GestureDetector(
                                                                  onTap: () {
                                                                    Navigator.pop(context);
                                                                    Navigator.push( context,
                                                                      MaterialPageRoute(builder: (context) => EditClientProfile(editFieldChoice: 'prices',)),
                                                                    );
                                                                  },
                                                                  child: roundedButton(
                                                                      "PRICES",
